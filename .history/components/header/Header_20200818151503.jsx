    ...
    <header className="header">
      ...
      <div className="header-phone-logo-box">
        <div className="header-phone-logo-keeper">
          <FontAwesomeIcon icon={faBars} className="header-phone-logo" />
        </div>
      </div>
      ...
      <div className="header-navbar">
        <div className="header-navbar-left">
          <a href="#" className="header-navbar-item" id="blog-section-link">
            بلاگ
          </a>
          <a href="#" className="header-navbar-item" id="games-section-link">
            بازی ها
          </a>
        </div>
        <div className="header-navbar-item-center"></div>
        <div className="header-navbar-right">
          <a href="#" className="header-navbar-item" id="aboutus-section-link">
            درباره ما
          </a>
          <a href="#" className="header-navbar-item" id="home-section-link">
            خانه
          </a>
        </div>
      </div>
