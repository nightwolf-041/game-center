...
function Header() {
  return (
    <header class="header">
      ...
      <img src="/BGIcon.png" alt="logo" class="mobile-header-logo" />
      <img src="/BGIcon.png" alt="logo" class="header-logo" />
        ...
        <div class="header-top-left">
          <div class="header-top-left-socials">
            ...
            <a href="#" class="header-socials-tooltip" data-title="twitch">
              <img src="/twitch.png" alt="" class="header-top-left-social" />
            </a>
            <a href="#" class="header-socials-tooltip" data-title="اینستاگرام">
              <img src="/instagram.png" alt="" class="header-top-left-social" />
            </a>
            <a href="#" class="header-socials-tooltip" data-title="تلگرام">
              <img src="/telegram.png" alt="" class="header-top-left-social" />
            </a>
          </div>
