...
function Weblog(props) {
  ...
  let [activeBlog, setActiveBlog] = useState('inActive');
  ...
  return (
    <>
      <Context.Provider value={usersContext}>{children}</Context.Provider>
...
// export const blogLinkContext = createContext(activeBlog);
