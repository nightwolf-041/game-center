...
function Weblog(props) {
  ...
  let [activeBlogLink, setActiveBlogLink] = useState('inActive');
  ...
  useEffect(() => {
    ...
    document.addEventListener('scroll', () => {
      if (window.scrollY > elemStart && window.scrollY < elemEnd) {
        setActiveBlogLink('active');
      } else {
        setActiveBlogLink('inActive');
      }
    });
  });
  ...
  return (
    // <blogLinkContext.Provider value={{ content: activeBlogLink }}>
