  ...
  const registerStep1ClickHandler = () => {
    if (!nameInput) {
      this.setState({
        ...
        nameInputValidMsg: 'الزامیست',
      });
    } else if (nameInput.length < 3) {
      this.setState({
        nameInputValid: false,
        nameInputValidMsg: 'کوتاه است',
      });
    } else {
      this.setState({ nameInputValid: true, nameInputValidMsg: '' });
    }
