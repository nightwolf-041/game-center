...
export default function Home() {
    ...
    const hideRegisterSuccessModal = () => {
    ...
    return ( <
        ...
        ContactUs / >
        <
        Footer blogHeader = { false }
        />

        <
        LoginRegisterModal show = { showLoginRegisterModal }
